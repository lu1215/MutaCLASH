...
#             plt.savefig('figure/G22_plot/22G/{}_group{}_{}_{}_{}.png'.format(d_name, str(group), mut, d_n, score_type), bbox_inches='tight')
#             plt.clf()
#             plt.close()
#             gc.collect()
...
#             plt.tight_layout()
#             plt.savefig('figure/G22_plot/22G/group{}_{}_{}_{}_without0.png'.format(str(group), mut, d_n, score_type))
#             plt.clf()
#             plt.close()
#             gc.collect()
...
#         print()
        ...
        for d1, d2 in zip(d1_list, d2_list):
            ...
            ax1.tick_params(axis='x', labelsize=14)
            sns.boxplot(data=tmp, ax=ax1, showfliers=False, width=0.5, linewidth=1, showmeans=0,medianprops=dict(color='orange'),
                        order=tmp.columns.to_list()[::-1], whis=1.5, boxprops = {'color':'black', 'facecolor':'pink', 'alpha':0.7}, whiskerprops={'linestyle':'--'})
            for p in ax1.artists:
                b, o, g, a = p.get_facecolor()
                p.set_facecolor((b, o, g, 0.3))
...
#             plt.tight_layout()
#             plt.savefig('figure/G22_plot/tmp/{}_group{}_{}_{}_{}.png'.format(d_name, str(group), mut, d_n, score_type))
#             plt.clf()
#             plt.close()
#             gc.collect()
...
#             plt.tight_layout()
#             plt.savefig('figure/G22_plot/FOLD_CDF/{}_group{}_{}_{}_{}_without0.png'.format(d_name, str(group), mut, d_n, score_type))
#             plt.clf()
#             plt.close()
#             gc.collect()
...
for group in group_list:
    for score_range in score_list:
        for mut in ['D', 'M']:
            ...
            plt.tight_layout()   
            plt.savefig('figure/G22_plot/per_score/{}_group{}_{}_{}_{}_with_mutation.png'.format(d_name, str(group), mut, score_type, str(score_range)))
            plt.clf()
            plt.close()
            gc.collect()
'''
